...
public class Deployments {
    ...
    @Deployment(order = 5, name = "normal")
    ...
    @Deployment(order = 13, name = "extra")
    ...
    @Deployment(order = 3, name = "autogenerated")
    public static Archive<?> generateAutogeneratedDeployment() throws IOException {
        EnterpriseArchive ear = EarGenericBuilder.getModuleDeployment(ModuleType.EJB, "autogenerated");
